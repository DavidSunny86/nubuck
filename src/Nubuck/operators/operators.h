...
private:
    ...
    enum { BUSY_THRESHOLD = 2 };                    // driver is considered busy iff threshold < actionsPending
...
public:
    ...
    // sends event to driver. drops event when driver is busy. should be used
    // for events generated by button clicks.
